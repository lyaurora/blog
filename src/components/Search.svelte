...
">
    <IconInline icon="material-symbols:search" class="absolute text-[1.25rem] pointer-events-none ml-3 transition my-auto text-black/30 dark:text-white/30"></IconInline>
...
<button on:click={togglePanel} aria-label="Search Panel" id="search-switch"
    ...
    <IconInline icon="material-symbols:search" class="text-[1.25rem]"></IconInline>
</button>
    ...
    {#each result as item}
       ...
       rounded-xl text-lg px-3 py-2 hover:bg-[var(--btn-plain-bg-hover)] active:bg-[var(--btn-plain-bg-active)]">
            <div class="transition text-90 inline-flex font-bold group-hover:text-[var(--primary)]">
                {item.meta.title}<IconInline icon="fa6-solid:chevron-right" class="transition text-[0.75rem] translate-x-1 my-auto text-[var(--primary)]"></IconInline>
            </div>
